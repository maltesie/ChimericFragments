function chimeric_browser(results_folder::String, genome_file::String, types::Dict{String,String}, min_reads::Int, max_fdr::Float64, address::String, port::Int)
    ...
    interactions, gene_names_types, gene_name_position, genome_info = load_data(results_folder, genome_file, min_reads, max_fdr)
    ...
    update_selection_callback!(app, interactions, gene_names_types, gene_name_position, types["srna"])
