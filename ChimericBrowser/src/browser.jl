function chimeric_browser(results_folder::String, genome_file::String, srna_type::String)
    ...
    interactions_dfs, singles_dfs, stats_matrices, gene_names_types, genome_info = load_data(results_folder, genome_file)
    ...
    update_selected_element_callback!(app, stats_matrices)
