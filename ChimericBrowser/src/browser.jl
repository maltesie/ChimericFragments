function chimeric_browser(results_folder::String, genome_file::String, types::Dict{String,String},
        ...
        check_interaction_distances::Tuple{Int,Int}, param_dict::Vector{Pair{String, String}})
    ...
    update_selected_element_callback!(app, genome, max_interaction_pvalue, check_interaction_distances)
