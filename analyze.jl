...
bams = align_mem(fastqs, genome; bwamem_bin=bwa_mem2_bin, samtools_bin=samtools_bin, is_interleaved_paired_end=is_interleaved_paired_end, min_score=min_alignment_score,
