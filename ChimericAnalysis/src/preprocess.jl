...
function align_mem(in_file1::String, in_file2::Union{String,Nothing}, genome_file::String, out_file::String;
    ...
    min_seed_len=18, reseeding_factor=1.4, is_ont=false, is_single_file_paired_end=false, threads=6, bwa_bin="bwa-mem2", sam_bin="samtools")
...
align_mem(in_file::String, genome_file::String, out_file::String;
    ...
    reseeding_factor=1.4, is_ont=false, is_single_file_paired_end=false, threads=6, bwa_bin="bwa-mem2", sam_bin="samtools") =
    align_mem(in_file, nothing, genome_file, out_file;
        ...
        reseeding_factor=reseeding_factor, is_single_file_paired_end=is_single_file_paired_end, is_ont=is_ont, threads=threads, bwa_bin=bwa_bin, sam_bin=sam_bin)
...
function align_mem(read_files::T, genome::Genome; min_score=20, match=1, mismatch=4, gap_open=6, gap_extend=1,
    ...
    is_single_file_paired_end=false, threads=6, bwa_bin="bwa-mem2", sam_bin="samtools", overwrite_existing=false) where {T<:FileCollection}
    ...
    for file in read_files
        ...
        align_mem(file, tmp_genome, out_file;
                ...
                reseeding_factor=reseeding_factor, is_ont=is_ont, is_single_file_paired_end=is_single_file_paired_end,
                threads=threads, bwa_bin=bwa_bin, sam_bin=sam_bin) :
